...
define( 'DATAMACHINE_CODE_VERSION', '0.47.17' );
...
/**
 * Resolve the current agent slug for AGENTS.md command examples when available.
 *
 * @return string Agent slug, or empty string when unresolved.
 */
function datamachine_code_resolve_agent_slug_for_agents_md(): string {
