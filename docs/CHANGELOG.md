...
### Added
- refresh primaries without WordPress

## [0.73.1] - 2026-08-30

### Fixed
- canonicalize freshness ref digests
...
### Fixed
- Fix worktree staleness remediation
...
### Changed
- Make the fixture guard survive concurrent worktree churn
...
### Changed
- expose registration backend seam

## [0.72.1] - 2026-08-26

### Fixed
- complete freshness timeout evidence

## [0.72.0] - 2026-08-26

### Added
- resolve tasks without WordPress

## [0.71.3] - 2026-08-26

### Fixed
- verify fallback transport end to end
...
### Fixed
- preserve bounded removal evidence
...
### Fixed
- allow owner-identical live retries
...
### Fixed
- defer registration before API load
...
### Fixed
- make worktree options optional
...
### Fixed
- preserve detached remote commits
...
### Fixed
- repair detached primary refresh
...
### Fixed
- reclaim artifacts before capacity refusal
...
### Added
- enforce workspace inode capacity

## [0.54.4] - 2026-07-28

### Fixed
- protect live worktree artifacts during cleanup
...
### Fixed
- report partial worktree cleanup success
...
### Fixed
- Fix worktree bootstrap artifact cleanup
...
### Changed
- drop generic WordPress guidance
...
### Fixed
- apply reviewed artifact cleanup plans
...
### Fixed
- Fix cleanup force policy assignment alignment
