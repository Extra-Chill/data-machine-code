...
namespace {
    include_once dirname(__DIR__) . '/inc/CodeTask/EvidencePacket.php';
    include_once dirname(__DIR__) . '/inc/CodeTask/CodeTaskWorkspaceInterface.php';
    include_once dirname(__DIR__) . '/inc/CodeTask/CodeTaskEvidenceWriterInterface.php';
    include_once dirname(__DIR__) . '/inc/CodeTask/CodeTaskCreator.php';
