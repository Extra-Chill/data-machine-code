...
namespace {
	...
	worktree_help_assert(array_column($add['synopsis'], 'name') === array( 'repo', 'branch', 'from', 'base', 'base-ref', 'base-branch', 'skip-context-injection', 'skip-bootstrap', 'allow-stale', 'allow-unverified-freshness', 'rebase-base', 'force', 'allow-percentage-byte-floor', 'remediate-capacity', 'remediate-capacity-dry-run', 'task-url', 'task-ref', 'require-task-tracker', 'reuse-policy', 'purpose', 'owner-run-ref', 'cleanup-policy', 'verbose', 'format' ), 'Add help option snapshot changed.');
