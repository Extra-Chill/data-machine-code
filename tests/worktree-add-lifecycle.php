...
try {
	...
	$interrupted_metadata['provisioning']['bootstrap']['active_child'] = array( 'pid' => 4242, 'identity' => array( 'platform' => 'test', 'pid' => 4242, 'token' => 'child' ) );
	...
	$posix_error_state = new ReflectionMethod(WorktreeContextInjector::class, 'bootstrap_posix_error_state');
	assert_true(array( 'state' => 'stale', 'reason' => 'owner_process_missing' ) === $posix_error_state->invoke(null, 3), 'portable ESRCH fallback did not classify a missing bootstrap owner');
	assert_true(array( 'state' => 'unverifiable', 'reason' => 'owner_probe_denied' ) === $posix_error_state->invoke(null, 1), 'portable EPERM fallback did not preserve fail-closed bootstrap ownership');
	assert_true(array( 'state' => 'unverifiable', 'reason' => 'owner_probe_unavailable' ) === $posix_error_state->invoke(null, 99), 'unknown POSIX errors did not remain unverifiable');
	...
	$interrupted_metadata['provisioning']['bootstrap']['capacity_reservation'] = array( 'bytes' => 10, 'inodes' => 1 );
	$interrupted_metadata['provisioning']['bootstrap']['coordinator'] = array( 'pid' => 999999, 'identity' => array( 'platform' => 'linux_proc', 'start_ticks' => '1' ) );
