...
namespace {
	...
	recovery_presentation_assert(false !== $ability_source && str_contains($ability_source, "'recovery'                  => array( 'type' => 'object' )"), 'Hygiene ability schema must declare recovery as an object.');
