...
namespace {
    ...
    include_once __DIR__ . '/../inc/Support/RunArtifactPrSectionRenderer.php';
    include_once __DIR__ . '/../inc/Support/RunArtifactBundleFileWriter.php';
    include_once __DIR__ . '/../inc/Handlers/GitHub/GitHubPullRequestPublish.php';
