...
namespace {
	...
	$assert(str_contains($ability_source, "'datamachine-code/get-github-check-runs'"), 'check-runs ability is registered');
	$assert(str_contains($ability_source, "'datamachine-code/get-github-commit-statuses'"), 'commit-statuses ability is registered');
