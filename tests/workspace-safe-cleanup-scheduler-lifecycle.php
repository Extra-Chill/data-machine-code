...
namespace {
	...
	$first  = \DataMachineCode\Abilities\WorkspaceAbilities::workspaceCleanupSafeRun(
		array(
			'request_id' => 'caller-retry-1',
			'dry_run'    => true,
		)
	);
	$second = \DataMachineCode\Abilities\WorkspaceAbilities::workspaceCleanupSafeRun(
		array(
			'request_id' => 'caller-retry-1',
			'dry_run'    => true,
		)
