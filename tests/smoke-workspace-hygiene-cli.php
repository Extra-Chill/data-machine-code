...
namespace {
    ...
    datamachine_code_hygiene_assert(in_array('table:25:metric,value', $GLOBALS['__cli_logs'], true), 'human output renders summary table with inventory freshness and lock counts');
