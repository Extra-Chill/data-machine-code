...
namespace {
    ...
    $built = \DataMachineCode\Workspace\WorktreeContextInjector::build_lifecycle_metadata(
        array(
    ...
    $built_bad_url = \DataMachineCode\Workspace\WorktreeContextInjector::build_lifecycle_metadata(
        array(
        'handle' => 'demo@bad-url',
    ...
    $built_explicit = \DataMachineCode\Workspace\WorktreeContextInjector::build_lifecycle_metadata(
        array(
        'handle'   => 'demo@bug-fix',
